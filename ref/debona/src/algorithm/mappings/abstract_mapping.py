...
class AbstractMapping:
    ...
    def is_linear(self) -> bool:
        raise NotImplementedError(f"is_linear(...) not implemented in {self.__class__.__name__}")
    ...
    def abstracted_torch_funcs(cls) -> list:
        ...
        raise NotImplementedError(f"abstracted_torch_funcs(...) not implemented in {cls.__class__.__name__}")
    ...
    def propagate(self, x: np.array, add_bias: bool = True) -> np.array:
        ...
        raise NotImplementedError(f"propagate(...) not implemented in {self.__class__.__name__}")
    ...
    def split_point(self, xl: float, xu: float) -> float:
        ...
        raise NotImplementedError(f"split_point(...) not implemented in {self.__class__.__name__}")
    ...
    def linear_relaxation(self, lower_bounds_concrete_in: np.array, upper_bounds_concrete_in: np.array,
        ...
        raise NotImplementedError(f"linear_relaxation(...) not implemented in {self.__class__.__name__}")
