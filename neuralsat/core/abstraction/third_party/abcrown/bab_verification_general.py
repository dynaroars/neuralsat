...
def config_args():
    ...
    h = ["data"]
    arguments.Config.add_argument("--dataset", type=str, default="ACASXU", choices=["ACASXU", "MNIST", "CIFAR", "CIFAR_SDP_FULL", "CIFAR_RESNET", "CIFAR_SAMPLE", "MNIST_SAMPLE", "CIFAR_ERAN", "MNIST_ERAN",
