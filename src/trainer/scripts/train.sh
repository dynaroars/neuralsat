...
python3 -m scripts.train_mnist --dataset torch/mnist --batch_size 128 --max_epoch 20 --model fc --output_folder fc --saver --output_name  mnist_256x2

python3 -m example.scripts.generate_instances_mnistfc --model_type fc --model_name mnist_256x2 --eps 0.15
