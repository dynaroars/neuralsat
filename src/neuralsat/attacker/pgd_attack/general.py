...
# @beartype
def attack(model, x: torch.Tensor, data_min: torch.Tensor, data_max: torch.Tensor,
...
# @beartype
def general_attack(model, X: torch.Tensor, data_min: torch.Tensor, data_max: torch.Tensor,
