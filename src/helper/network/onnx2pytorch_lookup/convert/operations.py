...
from helper.network.onnx2pytorch_lookup.convert.attribute import extract_attributes
from helper.network.onnx2pytorch_lookup.convert.layer import (
    convert_layer,
...
from helper.network.onnx2pytorch_lookup.operations import *
from helper.network.onnx2pytorch_lookup.operations.base import OperatorWrapper
from helper.network.onnx2pytorch_lookup.operations import Resize, Upsample
from helper.network.onnx2pytorch_lookup.utils import (
    get_inputs_names,
    get_outputs_names,
    value_wrapper,
)
...
def convert_operations(onnx_graph, opset_version, batch_dim=0, enable_pruning=True, quirks=None):
    ...
    if _quantized_ops_enabled(quirks):
        from helper.network.onnx2pytorch_lookup.operations.quantized_ops import (
