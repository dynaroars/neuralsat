            ...
            if isinstance(last_lA, eyeC) and isinstance(last_uA, eyeC):  # FIXME (12/28): we should check last_lA and last_uA separately. Same applies to the weight perturbed, bias perturbed settings.
                ...
                def _bound_oneside(last_A):
                    ...
                    if isinstance(last_A, torch.Tensor):
                        ...
                        # print('\t[_bound_oneside] weight', weight.shape)
                        # print('\t[_bound_oneside] reshaped_weight', reshaped_weight.shape)
                        ...
                        unfolded_weight = inplace_unfold(
                            ...
                            # inserted_zeros=max(last_A.inserted_zeros, 0),
                            inserted_zeros=last_A.inserted_zeros,
                            output_padding=last_A.output_padding)

                        # print('\t[_bound_oneside] unfolded_weight', unfolded_weight.shape)
                        # print('\t[_bound_oneside] last_A:', last_A.stride, last_A.padding, last_A.inserted_zeros, last_A.output_padding)
                        # print('\t[_bound_oneside] unstable_idx', last_A.unstable_idx)
                        ...
                        if last_A.unstable_idx is not None:
                            ...
                            # print('\t[_bound_oneside] unfolded_weight_r', unfolded_weight_r.shape)
                            ...
                            # print('\t[_bound_oneside] loi o day ne', last_A.patches.shape, selected_weight.shape)
                ...
                # print('- last_lA:', type(last_lA), last_lA.shape)
                lA_x, lbias = _bound_oneside(last_lA)
                # print('- last_uA:', type(last_uA))
